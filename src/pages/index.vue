      ...
      <v-col cols="12">
        <v-btn
          ...
          :disabled="
            ...
            (current.length === 0 && items.length === 0)"
          @click="startTimer"
        >
        </v-btn>
...
<!-- <template>
  <Time color="white" data="0"></Time>
  <Time color="white" data="1"></Time>
  <Time color="white" data="2"></Time>
  <Time color="white" data="3"></Time>
  <Time color="white" data="4"></Time>
  <Time color="white" data="5"></Time>
  <Time color="white" data="6"></Time>
  <Time color="white" data="7"></Time>
  <Time color="white" data="8"></Time>
  <Time color="white" data="9"></Time>
  <Time color="white" data=":"></Time>
</template> -->
