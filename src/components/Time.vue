<template>
  <svg
    ...
    width="314.067px"
    height="480.468px"
    viewBox="0 0 314.067 480.468"
    enable-background="new 0 0 314.067 480.468"
    xml:space="preserve"
  >
    <path
      ...
      class="time-a"
      fill="#138888"
      d="M293.86,15.904c0,8.784-17.282,15.905-24.286,15.905H44.493c-7.005,0-22.664-7.121-22.664-15.905l0,0
    ...
    <path
      ...
      class="time-b"
      fill="#138888"
      d="M293.86,240.231c0,8.784-17.282,15.905-24.286,15.905H44.493c-7.005,0-22.664-7.121-22.664-15.905l0,0
    ...
    <path
      ...
      class="time-c"
      fill="#138888"
      d="M15.907,221.186C7.123,221.186,0,203.906,0,196.9V63.687c0-7.005,7.123-22.664,15.907-22.664l0,0
    ...
    <path
      ...
      class="time-d"
      fill="#138888"
      d="M298.163,221.186c-8.784,0-15.907-17.28-15.907-24.286V63.687c0-7.005,7.123-22.664,15.907-22.664l0,0
    ...
    <path
      ...
      class="time-e"
      fill="#138888"
      d="M15.907,439.439C7.123,439.439,0,422.159,0,415.154V281.94c0-7.005,7.123-22.664,15.907-22.664l0,0
    ...
    <path
      ...
      class="time-f"
      fill="#138888"
      d="M298.163,439.439c-8.784,0-15.907-17.28-15.907-24.285V281.94c0-7.005,7.123-22.664,15.907-22.664l0,0
    ...
    <path
      ...
      class="time-g"
      fill="#138888"
      d="M293.86,464.561c0,8.784-17.282,15.907-24.286,15.907H44.493c-7.005,0-22.664-7.123-22.664-15.907l0,0
    ...
    <path
      :class="{ active: data === ':' }"
      fill="#138888"
      d="M178.517,349.358c0,11.864-9.619,21.481-21.484,21.481c-11.865,0-21.483-9.617-21.483-21.481
